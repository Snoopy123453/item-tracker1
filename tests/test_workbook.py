...
def test_workbook_structure_and_formula_safety() -> None:
    ...
    assert workbook.sheetnames == ["Summary", "Inputs", "Product Results", "Nearby Stores", "Spec Documents", "Manufacturer Sources", "OmniSearch Results", "Best Matches", "Price Comparison", "Review Notes"]
    ...
    for worksheet in workbook.worksheets:
        for row in worksheet.iter_rows():
            for cell in row:
                if worksheet.title != "Price Comparison":
